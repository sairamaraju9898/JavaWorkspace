...
public class AdactinHotelApp5 {

	
		// here if u want to execute @before method @after method for only two test cases but not remaing ones we can follow this approach
