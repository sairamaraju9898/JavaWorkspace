...
public void gmaillogintest() throws IOException, EncryptedDocumentException, InvalidFormatException, FrameworksException {
	...
	getDriver().get(url); //direct  calling without actionengine class 
	
	 actionengine.enterurl(url); // calling  through  actionengine class of enterurl method
...
//un.sendKeys("sairamaraju98@gmail.com");
	 actionengine.Dta(un,"sairamaraju98@gmail.com", "performing data Typing action"); //performing datatyping actiion by calling methods of action engine (Dta imethod contains datatyping action on 
	getExtentTest().log(LogStatus.PASS, "username  field is cleared");
